...
extern "C" void _ZN4dyld3logEPKcz(const char*, ...);

// dyld::halt(const char* msg);
extern "C" void _ZN4dyld4haltEPKc(const char* msg) __attribute__((noreturn));
...
void __assert_rtn(const char* func, const char* file, int line, const char* failedexpr)
{
    if (func == NULL)
        ...
        log("Assertion failed: (%s), function %s, file %s, line %d.\n", failedexpr, func, file, line);
    abort();
}
